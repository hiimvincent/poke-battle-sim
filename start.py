...
ps.PokeSim.start()
a = ps.PokeSim._move_list[random.randrange(250, 304) - 1][1]
b = ps.PokeSim._move_list[random.randrange(250, 304) - 1][1]
c = ps.PokeSim._move_list[random.randrange(250, 304) - 1][1]
d = ps.PokeSim._move_list[random.randrange(250, 304) - 1][1]
